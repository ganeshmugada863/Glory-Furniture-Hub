  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 max-w-md mx-auto bg-walnut-900 text-white p-4 rounded-2xl border border-gold-500/40 shadow-warm-lg flex items-center justify-between gap-3 animate-fade-in">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gold-500 flex items-center justify-center text-white font-sans font-bold text-lg">
          G
        </div>
        <div>
          <h4 className="font-sans font-bold text-xs text-white">Install Glory Furniture App</h4>
